...
export const SEGMENT_INTELLIGENCE: Record<string, SegmentIntelligence> = {
  'Základní školy': {
    ...
    approach: 'OZON Breeze Up do každé třídy + OZON Oasis Box do sborovny + OZON Storm Pro I PLUS pro tělocvičnu',
    recommendedProducts: ['OZON Breeze Up', 'OZON Oasis Box DRY', 'OZON Storm Pro I PLUS'],
  ...
  'Mateřské školy': {
    ...
    approach: 'OZON Breeze Up do heren + OZON Oasis Box na hračky a lůžkoviny',
    recommendedProducts: ['OZON Breeze Up', 'OZON Oasis Box DRY'],
  ...
  'Nemocnice a kliniky': {
    ...
    approach: 'Kompletní řešení s certifikací. OZON Breeze Up do pokojů + OZON Storm Pro I PLUS pro operační sály',
    recommendedProducts: ['OZON Breeze Up', 'OZON Storm Pro I PLUS', 'Certifikace prostoru', 'Technický audit'],
  ...
  'Kanceláře a coworkingová centra': {
    ...
    approach: 'OZON Breeze Up do open-space a zasedacích místností',
    recommendedProducts: ['OZON Breeze Up', 'Montáž a instalace'],
  ...
  'Hotely': {
    ...
    approach: 'OZON Breeze Up do pokojů + OZON Storm Pro I PLUS pro lobby a konferenční sály',
    recommendedProducts: ['OZON Breeze Up', 'OZON Storm Pro I PLUS'],
  ...
  'Fitness centra a posilovny': {
    ...
    approach: 'OZON Storm Pro I PLUS pro noční dezinfekci + OZON Oasis Box pro rukavice',
    recommendedProducts: ['OZON Storm Pro I PLUS', 'OZON Oasis Box DRY'],
  ...
  'Restaurace a kavárny': {
    ...
    approach: 'OZON Storm Pro I PLUS pro noční dezinfekci + OZON Oasis Box pro jídelní lístky',
    recommendedProducts: ['OZON Storm Pro I PLUS', 'OZON Oasis Box DRY'],
  ...
  'Výrobní podniky': {
    ...
    approach: 'OZON Storm Pro I PLUS pro výrobní haly + OZON Breeze Up do kanceláří',
    recommendedProducts: ['OZON Storm Pro I PLUS', 'OZON Breeze Up', 'Technický audit'],
  ...
  'Potravinářský průmysl': {
    ...
    approach: 'OZON Storm Pro I PLUS pro sklady a výrobní linky, certifikace klíčová',
    recommendedProducts: ['OZON Storm Pro I PLUS', 'Certifikace prostoru', 'Technický audit'],
  ...
  'Dopravní podniky (MHD)': {
    ...
    approach: 'OZON Storm Pro I PLUS mobilně do dep pro noční dezinfekci vozidel',
    recommendedProducts: ['OZON Storm Pro I PLUS'],
    avgDealSize: '150 000 - 400 000 Kč',
    closingTime: '6-12 měsíců (veřejné zakázky)',
