...
import { LayoutDashboard, Kanban, Users, Building2, Package, Target, Calculator, Shield, Zap, FileText, LogOut, Phone, Key } from 'lucide-react'
...
const menuItems = [
  ...
  { label: 'Kalkulačka', href: '/crm/calculator', icon: Calculator },
